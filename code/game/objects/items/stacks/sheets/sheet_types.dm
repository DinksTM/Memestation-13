...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new /datum/stack_recipe_list("airlock assemblies", list( \
		...
		new /datum/stack_recipe("large standard airlock assembly", /obj/structure/door_assembly/door_assembly_large, 4, time = 50, one_per_turf = 1, on_floor = 1), \
		...
		new /datum/stack_recipe("large mining airlock assembly", /obj/machinery/door/airlock/glass_cargo_large, 4, time = 50, one_per_turf = 1, on_floor = 1), \
		new /datum/stack_recipe("atmospherics airlock assembly", /obj/structure/door_assembly/door_assembly_atmo, 4, time = 50, one_per_turf = 1, on_floor = 1), \
		new /datum/stack_recipe("large atmospherics airlock assembly", /obj/structure/door_assembly/door_assembly_large_atmos, 4, time = 50, one_per_turf = 1, on_floor = 1), \
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("wood airlock assembly", /obj/structure/door_assembly/door_assembly_wood, 4, time = 50, one_per_turf = 1, on_floor = 1), \
	))
